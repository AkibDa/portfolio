...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative min-h-[90vh] flex flex-col md:flex-row items-center justify-between px-6 lg:px-24 pt-20 pb-12 overflow-hidden bg-white dark:bg-gray-950 transition-colors duration-300">
      {/* Background Decor */}
      ...
      >
        <div className="space-y-2">
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 dark:text-white leading-tight">
            I'm {PERSONAL_INFO.name.split(' ')[0]} <span className="text-indigo-600 dark:text-indigo-400">{PERSONAL_INFO.name.split(' ').slice(1).join(' ')}</span>
          </h1>
